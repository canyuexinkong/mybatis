...
public class MapperMethod {
    ...
    /**
     * /这个方法对返回值的类型进行了一些检查，使得更安全，一般用于update、delete、insert语句查询
     *
     * @param rowCount
     * @return
     */
    ...
    public static class SqlCommand {
        ...
        /**
         * 根据mapper接口、xml配置文件、调用的方法生成sql语句
         *
         * @param configuration   配置文件，mapperxml文件
         * @param mapperInterface 调用方法的借口类
         * @param method          接口类中被调用的方法
         */
    ...
    public static class MethodSignature {
        ...
        /**
         * 将接口方法中的参数解析成sql语句中的参数
         *
         * @param args 接口方法中的参数数组
         * @return
         */
