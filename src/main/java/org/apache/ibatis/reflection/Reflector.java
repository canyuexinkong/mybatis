...
public class Reflector {
     ...
     * 处理父类（接口）和子类中相同的方法
     *
     * @param conflictingGetters map，key是属性名，value是method的list对象
     */
    ...
    /**
     * 过滤掉一些不需要的属性记录，如$符号开始的字段名、序列化字段、class字段
     *
     * @param name 字段名
     * @return Boolean
     */
    ...
    /**
     * 将method生成map，保证一个key对应一个method
     *
     * @param uniqueMethods 已有的map集合
     * @param methods 方法集合
     */
